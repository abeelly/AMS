...
// Assign query results to variables dynamically
foreach ($qry as $k => $v) {
    $$k = $v;
}
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <dl>
                            ...
                            <dd><?php echo htmlspecialchars(ucwords($name)) ?></dd>
                    ...
                    <div class="col-sm-6">
                        ...
                        <dl>
                            ...
                            <dd>
                                ...
                                $status_text = $stat[$status];
                                $badge_class = $badge_classes[$status_text] ?? "badge-secondary";
                                ...
                                <?php if ($manager): ?>
                                    <div class="d-flex align-items-center mt-1">
                                        <img class="img-circle img-thumbnail p-0 shadow-sm border-info img-sm mr-3"
                                             src="assets/uploads/<?php echo htmlspecialchars($manager['avatar']) ?>" 
                                             alt="Avatar">
                                        <b><?php echo htmlspecialchars(ucwords($manager['name'])) ?></b>
                                    </div>
                                <?php else: ?>
