	...
	<div class="card card-outline card-danger">
		<div class="card-header">
			...
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-danger" href="./index.php?page=new_project"><i class="fa fa-plus"></i> Add New project</a>
			</div>
            <?php endif; ?>
		</div>
		<div class="card-body">
			<table class="table tabe-hover table-condensed" id="list">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center">
							<button type="button" class="btn btn-default btn-sm btn-flat border-danger wave-effect dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
		                      Action
		                    </button>
